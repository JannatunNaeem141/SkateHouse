    ...
    return (
        <footer class="footer footer-center p-10  text-primary-content">
            ...
            <div class="grid grid-flow-col gap-4">
                <Link to='/products' class="link link-hover">Products</Link>
                <Link to='/blog' class="link link-hover">Blogs</Link>
                <Link to='/about' class="link link-hover">About Us</Link>
                <Link to='/contact' class="link link-hover">Contact Us</Link>
            </div>
            <div>
                <p class="font-bold">
                    Skate House BD Ltd. <br />Providing inline skate parts since 2000
                </p>
