    ...
    return (
        <div style={{ backgroundImage: `url(${skate2})`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat', backgroundAttachment: 'fixed' }}>
            <div className='max-w-7xl mx-auto py-16'>
                <div className='grid justify-items-center lg:flex justify-center items-center h-96'>
                    <div className='flex justify-center items-center w-4/5 lg:w-1/2'>
                        <div><InboxInIcon className="h-10 w-10 mr-2 text-primary" /></div>
                        <div>
                            <p className='font-bold lg:text-2xl md:text-xl text-lg text-primary'>Sign up for our newsletter!</p>
